  ...
  _defaultItems() {
    return [
      ...
      },
      {
        key: 'TextArea',
        canHaveAnswer: true,
        name: 'Campo de texto com várias linhas',
        label: 'Placeholder...',
      ...
      },
      {
        key: 'TwoColumnRow',
        canHaveAnswer: false,
        name: 'Duas colunas em uma linha',
        label: '',
        icon: 'fas fa-columns',
      ...
      },
      {
        key: 'ThreeColumnRow',
        canHaveAnswer: false,
        name: 'Três colunas em uma linha',
        label: '',
        icon: 'fas fa-columns',
      ...
      },
      {
        key: 'FourColumnRow',
        canHaveAnswer: false,
        name: 'Quatro colunas em uma linha',
        label: '',
        icon: 'fas fa-columns',
      ...
      },
      {
        ...
        icon: 'fas fa-link',
        static: true,
        content: 'Placeholder de seu site ...',
        href: 'http://www.example.com',
      },
      {
        key: 'Download',
        name: 'Entrada de arquivos',
        icon: 'fas fa-file',
        static: true,
